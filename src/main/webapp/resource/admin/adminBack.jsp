    ...
    <ul class="sidenav-menu">
        <li>
            ...
            <ul class="sidenav-dropdown" data-sidenav-dropdown>
                ...
                <%--直接通过超链接跳转--%>
                <%--<li><a href="<%=basePath%>resource/admin/onProductManage.jsp">上架下架商品</a></li>--%>
                <%--设置id号，再下面原始代码里面通过点击id号来跳转--%>
                <li><a id="upAndDownProducts">上下架商品</a></li>
            </ul>
        </li>
        <li>
...
<script>
    ...
    $(function(){
        ...
        $("#myframe").attr("src","resource/admin/timesecharts.jsp");//之后改变src的值,//进来的时候针对是什么都没有,就是直接显示这个页面,当你点击的时候,才会此案是
        ...
        /*上下架商品*/
        $("#upAndDownProducts").click(function(){
            $("#myframe").attr("src","resource/admin/upAndDownProducts.jsp");
        });
